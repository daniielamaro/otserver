...
--></script>
<h4><font color=red>/war invite, guild enemy name </font>(Invite a guild to war! Default war use 100 frags count.)<br>

<font color=red>/war invite, guild enemy name, 300 </font>(Invite a guild to war with 300 frags count.)<br>

<font color=red>/war invite, guild enemy name, 300, 100000 </font>(Invite a guild to war with 300 frags count and payment of 100000 gold coins <- you need donate to guild to use it.)<br>

	example: <font color=red>/war invite, Murders Pride, 200, 1000000 </font>(Invite the guild Murders Pride to a war with 200 frags count, and bet(payment) of 1kk gold coin.)<br><br>



<font color=red>/war accept, guild enemy name </font>(Accept the war)<br>

	example: <font color=red>/war accept, Murders Pride </font>(Accept the war against guild Murders Pride.)<br><br>



<font color=red>/war cancel, guild enemy name </font>(Cancel a invitation of a war.)<br>

	example: <font color=red>/war cancel, Murders Pride </font>(Cancel my guild invitation to war with Murders Pride.)<br><br>



<font color=red>/war reject, guild enemy name </font>(Reject a invite for war.)<br>

	example: <font color=red>/war reject, Murders Pride </font>(Reject a invitation to war from Murders Pride.)<br><br>





<font color=red>/balance </font>(See the guild balance - balance of money.)<br>

<font color=red>/balance donate value </font>(Donate a value of money to your guild balance - all players can donate.)<br>

	example: <font color=red>/balance donate 100000 </font>(You will donate 100k to your guild balance.)<br>

<font color=red>/balance pick value </font>(Withdraw a value of money from your guild balance.)<br>

	example: <font color=red>/balance pick 100000 </font>(You will withdraw 100k from your guild balance.)<br>
