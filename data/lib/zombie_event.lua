...
-- POSITIONS
ZE_blockEnterItemPosition = {x= 98, y=521, z=5}
ZE_enterPosition = {x = 57, y = 525, z = 7}
ZE_kickPosition = {x=160, y=54, z=7}
ZE_spawnFromPosition = {x = 44, y = 514, z = 7}
ZE_spawnToPosition = {x = 70, y = 539, z = 7}
-- ITEM IDS
...
function spawnNewZombie()
	...
	local ret = (type(doCreateMonster("Event Zombie", {x=posx[lowest_i], y=posy[lowest_i], z=posz[lowest_i]}, false)) == 'number')
	if(ret) then
		addZombiesCount()
	end
	return ret
