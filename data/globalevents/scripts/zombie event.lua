local config = {
        ...
        teleportToPosition = {x = 57, y = 525, z = 7}, -- Where the teleport will take you
        ...
        playersNeededToStartEvent = 30, -- Players needed before the zombies can spawn.
        
        -- Should be the same as in the creaturescript!
        -- The zombies will spawn randomly inside this area
        fromPosition = {x = 50, y = 518, z = 7}, -- top left cornor of the playground
        toPosition = {x = 64, y = 535, z = 7}, -- bottom right cornor of the playground
        }
