-- CONFIG
ZE_DEFAULT_NUMBER_OF_PLAYERS = 25
-- POSITIONS
ZE_blockEnterItemPosition = {x= 436, y=493, z=7}
ZE_enterPosition = {x = 631, y = 643, z = 7}
ZE_kickPosition = {x=439, y=500, z=7}
ZE_spawnFromPosition = {x = 608, y = 603, z = 7}
ZE_spawnToPosition = {x = 653, y = 659, z = 7}
-- ITEM IDS
ZE_blockEnterItemID = 9772
-- STORAGES
-- - player
